...
<table width="400">
  <tr>
    <td colspan="2">
      <html:checkbox property="value(startjob)" value="true">
  ...
  <tr>
    ...
    <td>
      <html:select property="value(startprompttype)">
  ...
  <tr>
    ...
    <td>
      <html:textarea property="value(startprompttext)"></html:textarea>
    </td>
  </tr>
  <tr> <td>  </td> </tr>
  <tr>
    <td colspan="2">
      <html:checkbox property="value(endjob)" value="true">
  ...
  <tr>
    ...
    <td>
      <html:select property="value(endprompttype)">
        <html:option value="0"> <bean:message key="page.job.interactive.mode.prompt.type.display"/> </html:option>
        <html:option value="1"> <bean:message key="page.job.interactive.mode.prompt.type.confirm"/> </html:option>
      </html:select>
    </td>
  ...
  <tr>
    ...
    <td>
      <html:textarea property="value(endprompttext)"></html:textarea>
    </td>
  </tr>  
</table>
