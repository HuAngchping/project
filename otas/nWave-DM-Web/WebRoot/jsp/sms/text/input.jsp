...
<html:form action="/sms/text/send" method="post" focus="msisdn">
	<table class="entityview">
		<tbody>
		  ...
		  <jsp:include flush="true" page="/jsp/ota/omacp/form/targets.jsp"></jsp:include>
			...
			<tr>
				<th style="font-weight: normal">* <bean:message key="sms.text.content.label" /></th>
				<td>
	...
	<div class="buttonArea" style="height: 40px; weight: 100%;">
	    <input type="submit" name="method" value="<bean:message key="sms.text.button.send" />" class="NormalWidthButton">
	</div>
</html:form>
...
<!-- // create calendar object(s) just after form tag closed
  ...
  var scheduleCalendar = new calendar2(document.forms['TextSmsForm'].elements['scheduleTime']);
  scheduleCalendar.year_scroll = true;
  scheduleCalendar.time_comp = true;
  
  function popupCalendar() {
    document.forms['TextSmsForm'].elements['scheduleOption'][1].checked = true;
