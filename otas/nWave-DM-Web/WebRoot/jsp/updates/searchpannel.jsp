...
<table width="90%" border="0" align="center" cellpadding="0" cellspacing="5" class="mnutableborder">
	<tr>
		<td>
        <html:form action="/updates/updateimages">
          <table width="100%" border="0" align="left" cellpadding="2" cellspacing="0">
	        ...
	        <tr>
	          <td align="right">
	            <bean:message key="page.firmware.status.label" />:
	          </td>
	          <td>
	          <html:select property="searchStatus" styleClass="Select4SearchPannel">
	            <html:option value=""><bean:message key="page.select.search.option.default.label"/></html:option>
	        ...
	        <tr>
	          <td align="right">
	            <bean:message key="page.firmware.fromVersionID.label" />:
	          </td>
	          <td>
	          <html:text property="searchFromVersion" size="16"/>
	          </td>
	        </tr>
	        <tr>
	          <td align="right">
	            <bean:message key="page.firmware.toVersionID.label" />:
	          </td>
	          <td>
	          <html:text property="searchToVersion" size="16"/>
	          </td>
	        </tr>
	        <tr>
	          <td align="right">
