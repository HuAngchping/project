...
<table width="90%" border="0" align="center" cellpadding="0" cellspacing="5" class="mnutableborder">
	<tr>
		<td>
        <html:form action="/Subscribers">
          <table width="100%" border="0" align="left" cellpadding="2" cellspacing="0">
	        <tr>
	          <td align="right">
	            <bean:message key="page.subscribers.search.title.carrier" />:
	          </td>
	          <td>
          ...
          <tr>
	        ...
	        <tr>
	          <td align="right">
	            <bean:message key="page.subscribers.search.title.searchPhoneNumber" />:
	          </td>
	          <td>
	        ...
	        <tr>
	          <td align="right">
	            <bean:message key="page.subscribers.search.title.searchExternalID" />:
	          </td>
	          <td>
	        ...
	        <tr>
	          <td align="right">
	            <bean:message key="page.subscribers.search.title.searchActivity" />:
	          </td>
	          <td>
	        ...
	        <tr>
	          ...
	          <td>
	          <html:text property="searchDeviceExternalID" size="16"/>
	          </td>
	        </tr>
          <tr>
            <td align="right">
	        ...
	        <tr>
	          <td align="right">
	            <bean:message key="page.subscribers.search.title.searchText" />:
	          </td>
	          <td>
