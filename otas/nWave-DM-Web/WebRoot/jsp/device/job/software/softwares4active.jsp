...
<html:form action="/device/job/software/active/save">
    ...
    <TABLE class=table_box cellSpacing=0 cellPadding=0 width="100%" border="0">
      <TBODY>
      <TR>
        <TD class=table_box_heading width="100%" colSpan=5><font color="red"><b>.:</b></font> <bean:message key="page.device.job.software.active.softwares.label"/></TD>
      </TR>
      <TR>
        <TD>
          <logic:empty name="softwares">
              <font color="red"><bean:message key="page.device.job.software4active.message.noAvailiable"/></font>
          </logic:empty>
