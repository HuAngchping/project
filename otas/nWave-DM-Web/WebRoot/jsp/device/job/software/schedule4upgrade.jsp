...
<html:form action="/device/job/software/upgrade/save" method="post">
	...
	<table class="entityview">
		...
		<tr>
			<th>
				<bean:message key="page.device.job.software.upgrade.schedule.target.software.label" />
			</th>
			<td>
...
<!-- // create calendar object(s) just after form tag closed
	...
	var scheduleCalendar = new calendar2(document.forms['Form4SoftwareInstallation'].elements['jobSchedule']);
	scheduleCalendar.year_scroll = true;
	scheduleCalendar.time_comp = true;
	
	function popupCalendar() {
	  document.forms['Form4SoftwareInstallation'].elements['jobScheduleOption'][1].checked = true;
