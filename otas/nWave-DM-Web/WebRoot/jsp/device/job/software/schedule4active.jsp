...
<html:form action="/device/job/software/active/save" method="post">
...
<!-- // create calendar object(s) just after form tag closed
	...
	var scheduleCalendar = new calendar2(document.forms['Form4SoftwareActive'].elements['jobSchedule']);
	scheduleCalendar.year_scroll = true;
	scheduleCalendar.time_comp = true;
	
	function popupCalendar() {
	  document.forms['Form4SoftwareActive'].elements['jobScheduleOption'][1].checked = true;
