...
<div class="messageArea">
  <bean:message key="page.device.job.firmware.message" /><br><br>
...
<html:form action="/device/SaveFirmwareJob" method="post">
	...
	<table class="entityview">
	    ...
	    <tr>
	      ...
	      <td><bean:write name="device" property="model.name" /></td>
			...
			<tr>
				<th>
					<bean:message key="device.title.firmwareVersion" />
				</th>
				<td>
					<bean:write name="update" property="fromImage.versionId" /> -&gt; <bean:write name="update" property="toImage.versionId" />
				</td>
			</tr>
...
<!-- // create calendar object(s) just after form tag closed
	...
	var scheduleCalendar = new calendar2(document.forms['DeviceJobFirmwareForm'].elements['jobSchedule']);
	scheduleCalendar.year_scroll = true;
	scheduleCalendar.time_comp = true;
	
	function popupCalendar() {
	  document.forms['DeviceJobFirmwareForm'].elements['jobScheduleOption'][1].checked = true;
