...
<html:form action="/device/job/dm/EditProfileAssignment">
  <bean:define id="deviceID" name="device" property="ID"></bean:define>
  <input type="hidden" name="value(deviceID)" value="<bean:write name="deviceID"/>">
      ...
      <tr>
        <td>
          <display:table name="results" id="record"
            requestURI="<%=request.getContextPath() + "/device/job/dm/SelectProfileConfig.do"%>"
