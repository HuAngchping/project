...
<table width="90%" border="0" align="center" cellpadding="0" cellspacing="5" class="mnutableborder">
	<tr>
		<td>
        <html:form action="/device/job/cp/SelectProfileConfig">
          ...
          <table width="100%" border="0" align="left" cellpadding="2" cellspacing="0">
	        <tr>
	          ...
	          <td>
	          <html:select property="value(searchProfileCategoryID)" styleClass="Select4SearchPannel">
	        ...
	        <tr>
	          <td align="right">
	            <bean:message key="page.ProfileMappings.search.title.template" />:
	          </td>
	          <td>
	          <html:select property="value(searchProfileTemplateID)" styleClass="Select4SearchPannel">
	            <html:option value=""><bean:message key="page.select.search.option.default.label"/></html:option>
	            <html:optionsCollection name="templateOptions"/>
	          </html:select>
	          </td>
	        </tr>
	        <tr>
	          ...
	          <td>
	          <html:select property="value(searchProfileCarrierID)" styleClass="Select4SearchPannel">
	            <html:option value=""><bean:message key="page.select.search.option.default.label"/></html:option>
	        ...
	        <tr>
	          ...
	          <td>
	          <html:text property="value(searchProfileConfigName)" size="16"/>
	          </td>
	        </tr>
	        <tr>
	          <td align="right">
