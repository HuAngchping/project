...
<table width="90%" border="0" align="center" cellpadding="0" cellspacing="5" class="mnutableborder">
	<tr>
		<td>
        <html:form action="/devices/changeLogs">
          ...
          <tr>
            ...
            <td nowrap="nowrap">
            <html:text property="searchBeginTime" size="18" maxlength="19" style="font-size: 9px;"/>
...
<!-- // create calendar object(s) just after form tag closed
  ...
  var scheduleCalendar = new calendar2(document.forms['SearchDeviceChangeLogForm'].elements['searchBeginTime']);
  scheduleCalendar.year_scroll = true;
  scheduleCalendar.time_comp = true;
  
  function popupCalendar4BeginTime() {
    scheduleCalendar = new calendar2(document.forms['SearchDeviceChangeLogForm'].elements['searchBeginTime']);
    scheduleCalendar.year_scroll = true;
    scheduleCalendar.time_comp = true;
    scheduleCalendar.popup();
  }
  function popupCalendar4EndTime() {
    scheduleCalendar = new calendar2(document.forms['SearchDeviceChangeLogForm'].elements['searchEndTime']);
    scheduleCalendar.year_scroll = true;
    scheduleCalendar.time_comp = true;
    scheduleCalendar.popup();
  }
