...
<table width="90%" border="0" align="center" cellpadding="0" cellspacing="5" class="mnutableborder">
	<tr>
		<td>
        <html:form action="/profile/CPTemplates">
          <table width="100%" border="0" align="left" cellpadding="2" cellspacing="0">
	        <tr>
	          <td align="right">
	            <bean:message key="page.CPTemplates.search.title.manufacturer" />:
	          </td>
	          <td>
	        ...
	        <tr>
	          <td align="right">
	            <bean:message key="page.CPTemplates.search.title.model" />:
	          </td>
	          <td>
	        ...
	        <tr>
	          <td align="right">
	            <bean:message key="page.CPTemplates.search.title.category" />:
	          </td>
	          <td>
	        ...
	        <tr>
	          <td align="right">
	            <bean:message key="page.CPTemplates.search.title.searchText" />:
	          </td>
	          <td>
