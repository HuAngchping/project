...
<div class="messageArea">
	...
	<bean:message key="profile.template.err.explain.content" />
</div>
<br>
<div>
...
<div>
	<html:errors property="repeatCategoryErr" header="profile.errors.header" footer="profile.errors.footer"/>
</div>
<div>
	<html:errors property="noCategoryErr" header="profile.errors.header" footer="profile.errors.footer"/>
</div>
<div>
	<html:errors property="repeatTypeErr" header="profile.errors.header" footer="profile.errors.footer"/>
</div>
<div>
	<html:errors property="noTypeErr" header="profile.errors.header" footer="profile.errors.footer"/>
</div>
<div>
	<html:errors property="repeatTemplateErr" header="profile.errors.header" footer="profile.errors.footer"/>
</div>
<div>
