...
<table width="90%" border="0" align="center" cellpadding="0" cellspacing="5" class="mnutableborder">
	<tr>
		<td>
        <html:form action="/ProfileTemplates">
          <table width="100%" border="0" align="left" cellpadding="2" cellspacing="0">
	        <tr>
	          <td align="right">
	            <bean:message key="page.profiletemplates.search.title.category" />:
	          </td>
	          <td>
	        ...
	        <tr>
	          <td align="right">
	            <bean:message key="page.profiletemplates.search.title.searchNeedNap" />:
	          </td>
	          <td>
	          <html:select property="searchNeedNap">
	            <html:option value=""><bean:message key="page.select.search.option.default.label"/></html:option>
	        ...
	        <tr>
	          <td align="right">
	            <bean:message key="page.profiletemplates.search.title.searchNeedProxy" />:
	          </td>
	          <td>
	          <html:select property="searchNeedProxy">
	            <html:option value=""><bean:message key="page.select.search.option.default.label"/></html:option>
	            <html:option key="true" value="true"/>
	            <html:option key="false" value="false"/>
	          </html:select>
	        ...
	        <tr>
	          <td align="right">
	            <bean:message key="page.profiletemplates.search.title.searchText" />:
	          </td>
	          <td>
