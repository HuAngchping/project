...
<table width="90%" border="0" align="center" cellpadding="0" cellspacing="5" class="mnutableborder">
	<tr>
		<td>
        <html:form action="/ProfileMappings">
          <table width="100%" border="0" align="left" cellpadding="2" cellspacing="0">
	        <tr>
	          <td align="right">
	            <bean:message key="page.ProfileMappings.search.title.manufacturer" />:
	          </td>
	          <td>
	        ...
	        <tr>
	          <td align="right">
	            <bean:message key="page.ProfileMappings.search.title.model" />:
	          </td>
	          <td>
	        ...
	        <tr>
	          ...
	          <td>
	          <html:select property="searchTemplateID" styleClass="Select4SearchPannel">
	            <html:option value=""><bean:message key="page.select.search.option.default.label"/></html:option>
	        ...
	        <tr>
	          <td align="right">
	            <bean:message key="page.ProfileMappings.search.title.category" />:
	          </td>
	          <td>
	        ...
	        <tr>
	          <td align="right">
	            <bean:message key="page.ProfileMappings.search.title.searchText" />:
	          </td>
	          <td>
