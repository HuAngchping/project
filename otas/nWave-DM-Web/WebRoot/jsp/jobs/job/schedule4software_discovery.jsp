...
<html:form action="/jobs/job/software/discovery/save" method="post">
...
<!-- // create calendar object(s) just after form tag closed
	...
	var scheduleCalendar = new calendar2(document.forms['JobsJobSoftwareDiscoveryForm'].elements['jobSchedule']);
	scheduleCalendar.year_scroll = true;
	scheduleCalendar.time_comp = true;
	
	function popupCalendar() {
	  document.forms['JobsJobSoftwareDiscoveryForm'].elements['jobScheduleOption'][1].checked = true;
