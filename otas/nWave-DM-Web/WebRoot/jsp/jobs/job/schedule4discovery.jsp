...
<html:form action="/jobs/SaveDiscoveryJob" method="post">
  <logic:iterate id="nodeURI" name="JobsJobDiscoveryForm" property="nodeURIs">
...
<!-- // create calendar object(s) just after form tag closed
	...
	var scheduleCalendar = new calendar2(document.forms['JobsJobDiscoveryForm'].elements['jobSchedule']);
	scheduleCalendar.year_scroll = true;
	scheduleCalendar.time_comp = true;
	
	function popupCalendar() {
	  document.forms['JobsJobDiscoveryForm'].elements['jobScheduleOption'][1].checked = true;
