...
<html:form action="/jobs/cp/SaveProfileAssignment" onsubmit="return doSubmit(this);" enctype='multipart/form-data'>
...
<table class="entityview">
  ...
  <tbody>
    ...
    <tr>
      <th style="width: 150px; white-space: nowrap;"><bean:message key="page.device.job.assignment.label.profile"/></th>
...
<!--  Attributes management  -->
	<div class="messageArea">
	  <bean:message key="page.jobs.profileAssignment.message1.attributes"/> &nbsp;<bean:message key="page.message.required"/>
	</div>
