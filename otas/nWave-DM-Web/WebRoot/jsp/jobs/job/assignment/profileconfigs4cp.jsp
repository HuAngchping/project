...
<html:form action="/jobs/cp/EditProfileAssignment">
  <table class=table_box cellSpacing=0 cellPadding=0 width="100%" border="0">
    ...
    <tr>
      <td>
      	<display:table name="results" id="record" requestURI="<%=request.getContextPath() + "/jobs/cp/SelectProfileConfig.do"%>"  pagesize="<%=BaseAction.getRecordsPerPage(request)%>" class="simple_inline">
