...
<html:form action="/jobs/job/software/active/save" method="post">
	...
	<table class="entityview">
		<tbody>
            ...
            <tr>
              <th>
                <bean:message key="page.device.job.software.active.schedule.target.software.label" />
              </th>
              <td>
...
<!-- // create calendar object(s) just after form tag closed
	...
	var scheduleCalendar = new calendar2(document.forms['JobsJobSoftwareActiveForm'].elements['jobSchedule']);
	scheduleCalendar.year_scroll = true;
	scheduleCalendar.time_comp = true;
	
	function popupCalendar() {
	  document.forms['JobsJobSoftwareActiveForm'].elements['jobScheduleOption'][1].checked = true;
