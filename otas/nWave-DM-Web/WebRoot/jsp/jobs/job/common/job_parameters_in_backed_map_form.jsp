...
<%@ taglib uri="http://struts.apache.org/tags-tiles" prefix="tiles"%>
  ...
  <tr>
    ...
    <td>
       <html:text property="value(concurrentSize)" size="8"></html:text>
  ...
  <tr>
    ...
    <td>
       <html:text property="value(concurrentInterval)" size="8"></html:text> <bean:message key="page.device.jobs.job.concurrentInterval.seconds.label"/>
