...
<html:form action="/jobs/job/software/uninstall/save" method="post">
...
<!-- // create calendar object(s) just after form tag closed
	...
	var scheduleCalendar = new calendar2(document.forms['JobsJobSoftwareUninstallForm'].elements['jobSchedule']);
	scheduleCalendar.year_scroll = true;
	scheduleCalendar.time_comp = true;
	
	function popupCalendar() {
	  document.forms['JobsJobSoftwareUninstallForm'].elements['jobScheduleOption'][1].checked = true;
