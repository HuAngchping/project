...
<table class=table_box cellSpacing=0 cellPadding=0 width="100%" border="0">
  <tbody>
  <tr>
    <td class=table_box_heading width="100%" colSpan=5><font color="red"><b>.:</b></font> <bean:message key="page.jobs.job.device.dmSessionTracking.sumary.header.message"/></td>
  </tr>
  <tr>
    <td>
      <display:table name="results" id="record" pagesize="<%=BaseAction.getRecordsPerPage(request)%>" class="simple_inline">
       ...
       <display:column titleKey="entity.DmTrackingLogSum.label.endtime">
         <c:out value="${record.endTimeStamp}"/>
       </display:column>       
       <display:column property="duration" titleKey="entity.DmTrackingLogSum.label.duration" format="{0,number,#,000}"/>  
