/**
  * $Header: /home/master/nWave-DM-Web/src/com/npower/dm/util/ServletRequestUtils.java,v 1.1 2007/02/13 04:10:40 zhao Exp $
  * $Revision: 1.1 $
...
public abstract class ServletRequestUtils {
  ...
  /**
   * Get an Integer parameter, or <code>null</code> if not present. Throws an
  ...
  /**
   * Get an int parameter, with a fallback value. Never throws an exception. Can
   * pass a distinguished value as default to enable checks of whether it was
   * supplied.
   * 
   * @param request
   *          current HTTP request
  ...
  /**
   * Get a long parameter, with a fallback value. Never throws an exception. Can
   * pass a distinguished value as default to enable checks of whether it was
   * supplied.
   * 
   * @param request
  ...
  /**
   * Get an array of long parameters, throwing an exception if not found or one
   * is not a number.
   * 
   * @param request
   *          current HTTP request
  ...
  /**
   * Get an array of float parameters, throwing an exception if not found or one
   * is not a number.
   * 
   * @param request
   *          current HTTP request
  ...
  /**
   * Get a double parameter, throwing an exception if it isn't found or isn't a
   * number.
   * 
   * @param request
   *          current HTTP request
