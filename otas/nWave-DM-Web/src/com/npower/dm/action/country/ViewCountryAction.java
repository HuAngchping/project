/**
 * $Header: /home/master/nWave-DM-Web/src/com/npower/dm/action/country/ViewCountryAction.java,v 1.1 2007/03/30 11:02:21 zhao Exp $
 * $Revision: 1.1 $
 ...
 */
public class ViewCountryAction extends AbstractCountryAction {
  ...
  public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request,
    ...
    String countryID = (String) countryForm.get("ID");
    try {
        if (StringUtils.isNotEmpty(countryID)) {
           // Load data from DB
           Country country = this.getCountry(request, countryID);
