 ...
 */
public class SaveJob4SoftwareDiscoveryAction extends BaseLookupDispatchAction {
  ...
  public ActionForward schedule(ActionMapping mapping, ActionForm rawForm, HttpServletRequest request,
    ...
    String jobType = ProvisionJob.JOB_TYPE_SOFTWARE_DISCOVERY;
    String[] parameters4JobName = null;
  ...
  public ActionForward update(ActionMapping mapping, ActionForm rawForm, HttpServletRequest request,
    ...
    try {
        ...
        ProvisionJob job = jobBean.newJob4SoftwareDiscovery(group);
