/**
 * $Header: /home/master/nWave-DM-Web/src/com/npower/dm/action/jobs/DMSessionTrackingLogDetail4DeviceAction.java,v 1.4 2009/02/12 06:26:45 zhao Exp $
 * $Revision: 1.4 $
...
import com.npower.dm.hibernate.entity.DmTrackingLogDetail;
...
public class DMSessionTrackingLogDetail4DeviceAction extends BaseAction {

  /**
   * 
   */
  public DMSessionTrackingLogDetail4DeviceAction() {
    super();
  }
  ...
  public ActionForward execute(ActionMapping mapping, ActionForm rawForm, HttpServletRequest request,
    ...
    try {        
      ...
      Criteria criteria = searchBean.newCriteriaInstance(DmTrackingLogDetail.class);
