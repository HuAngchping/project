 ...
 */
public class SaveJob4SoftwareDiscovery extends BaseLookupDispatchAction {
  ...
  protected Map getKeyMethodMap()
  {
    ...
    map.put("page.button.previous.label", "cancelled");
    return(map);
  }
  ...
  public ActionForward schedule(ActionMapping mapping, ActionForm rawForm, HttpServletRequest request,
    ...
    String jobName = ActionHelper.getDefaultJobName(messageResources, this.getLocale(request), ProvisionJob.JOB_TYPE_SOFTWARE_DISCOVERY, null);
  ...
  public ActionForward update(ActionMapping mapping, ActionForm rawForm, HttpServletRequest request,
    ...
    try {
        ...
        ProvisionJob job = jobBean.newJob4SoftwareDiscovery(device);
