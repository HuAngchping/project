 ...
 */
public class SaveJob4SoftwareInstallation extends BaseLookupDispatchAction {
  ...
  public ActionForward schedule(ActionMapping mapping, ActionForm rawForm, HttpServletRequest request,
    ...
    try {
        ...
        String jobName = ActionHelper.getDefaultJobName(messageResources, this.getLocale(request), ProvisionJob.JOB_TYPE_SOFTWARE_INSTALL, 
                                                        new String[]{software.getName()});
