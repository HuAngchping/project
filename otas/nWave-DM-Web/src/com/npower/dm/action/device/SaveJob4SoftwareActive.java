 ...
 */
public class SaveJob4SoftwareActive extends BaseLookupDispatchAction {
  ...
  public ActionForward schedule(ActionMapping mapping, ActionForm rawForm, HttpServletRequest request,
    ...
    try {
        ...
        String jobName = ActionHelper.getDefaultJobName(messageResources, this.getLocale(request), ProvisionJob.JOB_TYPE_SOFTWARE_ACTIVE, new String[]{software.getName()});
  ...
  public ActionForward update(ActionMapping mapping, ActionForm rawForm, HttpServletRequest request,
    ...
    try {
        ...
        ProvisionJob job = jobBean.newJob4SoftwareActivation(device, software);
