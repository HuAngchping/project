 ...
 */
public class SaveJobFirmwareAction extends BaseLookupDispatchAction {
  ...
  public ActionForward schedule(ActionMapping mapping, ActionForm rawForm, HttpServletRequest request,
    ...
    try {
        ...
        String jobName = ActionHelper.getDefaultJobName(messageResources, this.getLocale(request), ProvisionJob.JOB_TYPE_FIRMWARE, new String[]{update.getToImage().getVersionId()});
  ...
  public ActionForward edit(ActionMapping mapping, ActionForm rawForm, HttpServletRequest request,
    ...
    EditJobAction.setFirmwares4View(request, factory, deviceBean, device);
