...
public class AttributeTypeUploadAction extends BaseAction {
  ...
  public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception {
    ...
    if (form instanceof UpLoadForm) {
      ...
      try {
        ...
        String fileUploadPath = System.getProperty("java.io.tmpdir") + fileSeparator + "AttributeTypeXml";
        ...
        String AttributeTypeName = filedir.substring(filedir.lastIndexOf(fileSeparator) + 1, filedir.length());

        session.setAttribute("AttributeTypeName", AttributeTypeName);
