/**
  * $Header: /home/master/nWave-DM-Web/src/com/npower/dm/action/profile/RemoveProfileMappingAction.java,v 1.3 2007/02/08 10:50:28 zhao Exp $
  * $Revision: 1.3 $
...
/**
 * @author Zhao DongLu
 * @version $Revision: 1.3 $ $Date: 2007/02/08 10:50:28 $
 */
public class RemoveProfileMappingAction extends BaseAction {
  ...
  public ActionForward execute(ActionMapping mapping, ActionForm rawForm, HttpServletRequest request,
    ...
    try {
       ...
       modelBean.dettachProfileMapping(model, profileMapping.getID());
       mappingBean.delete(profileMapping);
