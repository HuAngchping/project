...
<hr class="WizardHR"/>
<html:form action="/wizard/dm/InputPhone" method="POST" focus="value(phoneNumber)">
...
<tr>
	<th></th>
	<td>
	  <bean:message key="page.cp.wizard.input.phone.checkcode.hint"/><br/>
	  <html:img action="/common/checkcode.do" style="vertical-align: bottom" styleClass="check_code_image"/>
  </td>
</tr>
</table>
</div>
