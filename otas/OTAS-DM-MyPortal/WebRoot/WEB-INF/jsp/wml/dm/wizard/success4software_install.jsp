...
<div class="WizardForm" style="padding-left: 10px;">
  ...
  <div style="font-size: 110%; font-weight: bold;"><html:img page="/common/images/help/icon_light.gif"/> <bean:message key="page.dm.wizard.success.help.1" arg0="${softwareName}"/></div>
  <div>
    <ul>
  ...
  <div style="margin-bottom: 10px; font-size: 110%; font-weight: bold;">
  ...
  <div style="margin-bottom: 20px; clear: both; font-size: 110%;">
    <html:img page="/common/images/help/icon_light.gif"/> <bean:define id="RetryURL"><html:rewrite action="/wap/wizard/dm/software/msm/input.do?softwareID=${software.externalId}&value(modelID)=${model.ID}&countryID=${country.ID}&carrierID=${carrier.externalID}&value(phoneNumber)=${device.subscriber.phoneNumber}"/></bean:define><bean:message key="page.dm.wizard.success.help.10" arg0="${RetryURL}"/>
  </div>
</div>
